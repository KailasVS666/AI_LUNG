...
All three training stages have been completed using Kaggle and Google Colab GPU instances.

### Stage 1: 2.5D Image Denoising (`Denoise25DUNet`)
* **Validation PSNR:** **36.80 dB**
* **Key Feature:** Suppresses simulated Poisson noise and streak artifacts generated by radon forward projections to recover slice details.
...
- ✅ Stage 1: EfficientNet-B5 + CBAM 2.5D U-Net training
- ✅ Stage 1→2 bridge: export_denoised.py with active cleanup routine
- ✅ Stage 2: 3D U-Net + 3D-CBAM training
- ✅ Stage 3: 3D CNN + CBAM training with self-healing weight loader
- ✅ Full end-to-end local inference validation and paper compilation
...
**Status**: All three pipeline training stages are complete.
